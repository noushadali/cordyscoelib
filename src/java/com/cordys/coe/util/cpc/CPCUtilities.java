 ...
 * 
 * @author pgussow
 * @deprecated This class does not use proper XPath XML libraries.
 */
public class CPCUtilities
{
    ...
    /**
     * This method concatenates all the String-tags in the passed on XML. The param iXMLNode should point to an XML of this
     * format:
     * 
     * <pre>
     *        &lt;roottag&gt;
     ...
     * </pre>
     * <p>
     * Given the sample XML the return will be: "This is the first part2nd part Last part"
     * </p>
     * 
    ...
    /**
     * Returns string value ifTrue (if expressionTrueFalse = "1" (true)) else ifFalse The code behind this function is very
     * simple:
     * <p>
     * return expressionTrueFalse.equals("1") ? ifTrue : ifFalse;
     * </p>
     * <p>
     * This function can be used in BPMs in BCP C3, since ? : expressions are not possible in BCP C3. However, this function is
     * only used in C2.
     * </p>
     * 
     ...
     */
    public static String conditionalExpression(String expressionTrueFalse, String ifTrue, String ifFalse)
    {
        return expressionTrueFalse.equals("1") ? ifTrue : ifFalse;
    }
     ...
     * </p>
     * <p>
     * This function can be used in BPMs in BCP C3, since ? : expressions are not possible in BCP C3. This function is used in C3.
     * </p>
     * 
     * @param expressionTrueFalse
     * @param ifTrue
     ...
     * @return ifTrue when expressionTrueFalse is true else ifFalse.
     */
    public static String conditionalExpression(boolean expressionTrueFalse, String ifTrue, String ifFalse)
    {
        return expressionTrueFalse ? ifTrue : ifFalse;
    }

    /**
     * This method returns a new XML structure based on the XML-structure passed on in the iInputDoc variable. The outputdocument
     * will have a roottag with a name that is the value of the tag &lt;roottag&gt; in the inputdoc. An example:
     * 
     * <pre>
     *         &lt;inputdoc&gt;
    ...
    /**
     * This method does simple calculations based on the XML that was received. iMathXML should point to an XML-structure like
     * this:
     * 
     * <pre>
     *        &lt;math&gt;
     ...
     * 
     * @param iMathXML The XML with the definition of the calculation.
     * @return An integer with the result of the calculation. The calculation is done with doubles, but the result is rounded to in
     *         Integer
     */
    ...
    /**
     * This is a dummy method. It does nothing, but it can be used to send a dummy message to. This method is needed so in a CPC
     * flow we can generate the message from the WSDL before it is actually used.
     * 
    ...
    /**
     * This method returns the date formatted by the given format. If sDate is null or empty the current date will be used. If
     * sFormat is null or empty the SQL-server default will be used (yyyy-mm-ddTHH:MM:SS.M If iDate is specified it should look
     * like this:
     * 
     * <pre>
     *        <date>
     ...
     * </pre>
     * <p>
     * The supported formats can be found at the JavaDoc for SimpleDateFormat
     * </p>
     * 
        ...
        if (iDate != 0)
        {
            ...
            if ((iYearNode != 0) && (iMonthNode != 0) && (iDayNode != 0))
            {
                try
                {
                    ...
                    cCal.set(Calendar.YEAR, Integer.parseInt(Node.getDataWithDefault(iYearNode, "0")));
                    cCal.set(Calendar.MONTH, Integer.parseInt(Node.getDataWithDefault(iMonthNode, "0")));
                    cCal.set(Calendar.DATE, Integer.parseInt(Node.getDataWithDefault(iDayNode, "0")));
                    cCal.set(Calendar.HOUR, Integer.parseInt(Node.getDataWithDefault(iHoursNode, "0")));
                    cCal.set(Calendar.MINUTE, Integer.parseInt(Node.getDataWithDefault(iMinutesNode, "0")));
                    cCal.set(Calendar.SECOND, Integer.parseInt(Node.getDataWithDefault(iSecondsNode, "0")));
                    cCal.set(Calendar.MILLISECOND, Integer.parseInt(Node.getDataWithDefault(iMilisecondsNode, "0")));
                    dDate = cCal.getTime();
                }
                catch (Exception e)
                {
