/**
 * (c) 2006 Cordys R&D B.V. All rights reserved. The computer program(s) is the proprietary information of Cordys B.V. and
...
public interface ICordysNomGatewayClient extends ICordysGatewayClientBase
{
     ...
     */
    int addMethod(int xRequest, String sMethod, String sNamespace) throws CordysGatewayClientException;
     ...
     * @throws CordysGatewayClientException DOCUMENTME
     */
    int createMessage(String sMethodName, String sNamespace) throws CordysGatewayClientException;
     ...
     */
    int requestFromCordys(int xRequest) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException DOCUMENTME
     */
    int requestFromCordys(int xRequest, long lTimeout) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException DOCUMENTME
     */
    int requestFromCordys(int xRequest, long lTimeout, String sSoapAction) throws CordysGatewayClientException,
            CordysSOAPException;
     ...
     * @throws CordysSOAPException DOCUMENTME
     */
    int requestFromCordysNoBlocking(int xRequest) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException DOCUMENTME
     */
    int requestFromCordysNoBlocking(int xRequest, long lTimeout) throws CordysGatewayClientException, CordysSOAPException;

    /**
     * This method will upload a file using the Upload.wcp extension.
     * 
     * @param xRequest The XML request that needs to be sent.
     ...
     */
    int uploadFile(int xRequest, File file) throws CordysGatewayClientException, CordysSOAPException;
}
