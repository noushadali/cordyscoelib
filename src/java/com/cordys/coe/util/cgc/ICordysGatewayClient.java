...
/**
 * This interface describes the methods that the Cordys web gateway supports. This is the DOM version of the client. All commong
 * methods are defined in class <code>ICordysGatewayClient</code>.
 */
public interface ICordysGatewayClient extends ICordysGatewayClientBase
{
     ...
     */
    Node addMethod(Node nRequest, String sMethod, String sNamespace) throws CordysGatewayClientException;
     ...
     * @throws CordysGatewayClientException In case of any exceptions.
     */
    Element createMessage(String sMethodName, String sNamespace) throws CordysGatewayClientException;
     ...
     * @throws CordysGatewayClientException In case of any exceptions.
     */
    LDAPEntry insertLDAPEntry(LDAPEntry leNew) throws CordysGatewayClientException;
     ...
     * @throws CordysGatewayClientException In case of any exceptions.
     */
    LDAPEntry readLDAPEntry(String sDN) throws CordysGatewayClientException;
     ...
     */
    Element requestFromCordys(Element eRequest) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordys(Element eRequest, String sReceiver) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordys(Element eRequest, long lTimeout) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordys(Element eRequest, long lTimeout, String sSoapAction) throws CordysGatewayClientException,
            CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordys(Element eRequest, long lTimeout, String sOrganization, String sSoapAction, String sReceiver)
            throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordysNoBlocking(Element eRequest) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordysNoBlocking(Element eRequest, String sReceiver) throws CordysGatewayClientException,
            CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordysNoBlocking(Element eRequest, long lTimeout) throws CordysGatewayClientException, CordysSOAPException;
     ...
     * @throws CordysSOAPException For SOAP related exceptions.
     */
    Element requestFromCordysNoBlocking(Element eRequest, long lTimeout, String sSoapAction) throws CordysGatewayClientException,
            CordysSOAPException;
     ...
     * @throws CordysGatewayClientException In case of any exceptions.
     */
    LDAPEntry[] searchLDAP(String sSearchRoot, int iLDAPScope, String sFilter) throws CordysGatewayClientException;
     ...
     * @throws CordysGatewayClientException In case of any exceptions.
     */
    LDAPEntry updateLDAPEntry(LDAPEntry leOld, LDAPEntry leNew) throws CordysGatewayClientException;
     ...
     * @throws CordysSOAPException In case a SOAP fault was returned.
     */
    Element uploadFile(Element request, File file) throws CordysGatewayClientException, CordysSOAPException;
}
