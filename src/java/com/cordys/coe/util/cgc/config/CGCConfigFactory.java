...
/**
 * This factory can be used to create configuration classes for the Cordys Gateway Client based on
 * diffenrent parameters.
 *
 * @author  pgussow
 */
public class CGCConfigFactory
{
    ...
    /**
     * Holds the default value for whether or not the login request should be sent with each
     * request. Setting it to false means it will only send it when the server requests it.
     */
    public static final boolean DEFAULT_AUTHENTICATION_PREEMPTIVE = false;
    /**
     * Holds the location of the default trust store.
     */
    public static final String DEFAULT_TRUST_STORE = System.getProperty("java.home") +
    ...
    public static ICGCConfiguration createConfiguration(URL uUrl)
    {
        ...
        return createConfiguration(host, port, pathBuilder.toString(), isSsl, DEFAULT_PROXY_HOST,
                                   DEFAULT_PROXY_PORT, DEFAULT_PROXY_USERNAME,
                                   DEFAULT_PROXY_PASSWORD, DEFAULT_CHECK_FOR_FAULTS,
                                   DEFAULT_LOGIN_TO_CORDYS, DEFAULT_NETWORK_TIMEOUT,
                                   DEFAULT_USE_SERVER_WATCHER, DEFAULT_SERVER_WATCHER_POLL_INTERVAL,
                                   DEFAULT_SLEEP_TIME, DEFAULT_SOAP_TIMEOUT,
                                   DEFAULT_MAX_CONNECTIONS_PER_HOST,
                                   DEFAULT_AUTHENTICATION_PREEMPTIVE, DEFAULT_TRUST_STORE,
                                   DEFAULT_TRUST_STORE_PASSWORD, DEFAULT_TRUST_STORE_TYPE,
                                   DEFAULT_ACCEPT_WHEN_EXPIRED, DEFAULT_ACCEPT_WHEN_INVALID,
    ...
    {
        return createConfiguration(sHost, DEFAULT_HTTP_PORT, DEFAULT_GATEWAY_URL, DEFAULT_SSL,
                                   DEFAULT_PROXY_HOST, DEFAULT_PROXY_PORT, DEFAULT_PROXY_USERNAME,
                                   DEFAULT_PROXY_PASSWORD, DEFAULT_CHECK_FOR_FAULTS,
                                   DEFAULT_LOGIN_TO_CORDYS, DEFAULT_NETWORK_TIMEOUT,
                                   DEFAULT_USE_SERVER_WATCHER, DEFAULT_SERVER_WATCHER_POLL_INTERVAL,
                                   DEFAULT_SLEEP_TIME, DEFAULT_SOAP_TIMEOUT,
    ...
    /**
     * This method creates the configuration for the Cordys Gateway Client based on the wgcConfig
     * object.
     *
    ...
    /**
     * This method creates a standard connection to a server and port. You can specify whether or
     * not the server is running under SSL.
     *
     * @param   sHost  The name of the host to connect to.
    ...
    {
        return createConfiguration(sHost, iPort, DEFAULT_GATEWAY_URL, bSsl, DEFAULT_PROXY_HOST,
                                   DEFAULT_PROXY_PORT, DEFAULT_PROXY_USERNAME,
                                   DEFAULT_PROXY_PASSWORD, DEFAULT_CHECK_FOR_FAULTS,
                                   DEFAULT_LOGIN_TO_CORDYS, DEFAULT_NETWORK_TIMEOUT,
                                   DEFAULT_USE_SERVER_WATCHER, DEFAULT_SERVER_WATCHER_POLL_INTERVAL,
     ...
     * @param   bAuthenticationPreemptive   Holds the default value for whether or not the login
     *                                      request should be sent with each request.
     ...
     * @param   iMaxConcurrentCalls         The maximum number of concurrent calls to the
     *                                      requestFromCordys method.
     * @param   tmTrustMode                 The trust mode to use.
     *
     * @return  The configuration to use.
     */
    public static ICGCConfiguration createConfiguration(String sHost, int iPort, String sGatewayURL,
                                                        boolean bSsl, String sProxyHost,
                                                        int iProxyPort, String sProxyUsername,
                                                        String sProxyPassword,
                                                        boolean bCheckForFaults,
                                                        boolean bLoginToCordysOnConnect,
                                                        long lNetworkTimeout,
                                                        boolean bUseServerWatcher,
                                                        long lServerWatcherPollInterval,
                                                        long lSleepTime, long lTimeout,
                                                        int iMaxConnectionsPerHost,
                                                        boolean bAuthenticationPreemptive,
                                                        String sTrustStore,
                                                        String sTrustStorePassword,
                                                        String sTrustStoreType,
                                                        boolean bAcceptWhenExpired,
                                                        boolean bAcceptWhenInvalid,
                                                        int iMaxConcurrentCalls,
                                                        ETrustMode tmTrustMode)
    {
        ICGCConfiguration ccReturn = null;
     ...
     * @param   sHost        The name of the host to connect to.
     * @param   iPort        The default port number.
     * @param   tmTrustMode  The trustmode to use. When USE_TRUSTSTORE is passed on, it will use the
     *                       default JRE trust store.
     *
     * @return  The configuration to use.
     */
    public static ICGCConfiguration createSSLConfiguration(String sHost, int iPort,
                                                           ETrustMode tmTrustMode)
    {
        return createConfiguration(sHost, iPort, DEFAULT_GATEWAY_URL, true, DEFAULT_PROXY_HOST,
                                   DEFAULT_PROXY_PORT, DEFAULT_PROXY_USERNAME,
                                   DEFAULT_PROXY_PASSWORD, DEFAULT_CHECK_FOR_FAULTS,
                                   DEFAULT_LOGIN_TO_CORDYS, DEFAULT_NETWORK_TIMEOUT,
                                   DEFAULT_USE_SERVER_WATCHER, DEFAULT_SERVER_WATCHER_POLL_INTERVAL,
