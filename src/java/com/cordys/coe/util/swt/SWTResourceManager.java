 ...
 * images, etc. !!! IMPORTANT !!! Application code must explicitly invoke the <code>dispose()</code>
 * method to release the operating system resources managed by cached objects when those objects and
 * OS resources are no longer needed (e.g. on application shutdown) This class may be freely
 * distributed as part of any application or plugin.
 *
...
public class SWTResourceManager
{
    ...
    public static void disposeImages()
    {
        ...
        //
        for (Iterator<HashMap<Image, Image>> I = m_ImageToDecoratorMap.values().iterator();
                 I.hasNext();)
        {
