...
/**
 * This class is meant to be used as an exception object for code which runs on an actual Cordys
 * server.
 *
 * @author  pgussow
 */
public class ServerLocalizableException extends Exception
{
    /**
     ...
     */
    public ServerLocalizableException(IStringResource srMessage, Object... aoParameters)
    {
     ...
     * @param  aoParameters  The list of parameters for the localizeable message.
     */
    public ServerLocalizableException(Throwable tCause, IStringResource srMessage,
                                      Object... aoParameters)
    {
     ...
     * @param  aoParameters  The list of parameters for the localizeable message.
     */
    public ServerLocalizableException(Throwable tCause, String sFaultActor,
     ...
     * @param  aoParameters       The list of parameters for the localizeable message.
     */
    public ServerLocalizableException(Throwable tCause, PreferredLocale plPreferredLocale,
