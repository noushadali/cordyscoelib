...
{
    /**
     * Identifies that this provider has to read based on filesize.
     */
    public static final int TYPE_BLOCK = 0;
    /**
     * Identifies that this provider has to read based on record count.
     */
     ...
     *
     * @see     com.cordys.coe.tools.es.swt.ILogContentProvider#getNextDataset(com.cordys.coe.tools.es.swt.AbstractEventPanel)
     */
    public synchronized void getNextDataset(AbstractEventPanel aepPanel)
                                     throws IOException
    {
        m_iCurrentPage++;
     ...
     * @throws  IOException  DOCUMENTME
     *
     * @see     com.cordys.coe.tools.es.swt.ILogContentProvider#getPreviousDataset(com.cordys.coe.tools.es.swt.AbstractEventPanel)
     */
    public void getPreviousDataset(AbstractEventPanel aepPanel)
                            throws IOException
    {
