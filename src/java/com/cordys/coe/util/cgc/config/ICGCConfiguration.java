...
/**
 * This interface contains the methods for the basic configuration of the Cordys Gateway Client.
 * This interface has no connection with either the Authentication scheme to be used nor with any
 * XML library.
 *
 * @author  pgussow
 */
public interface ICGCConfiguration
{
    ...
    /**
     * This method gets whether or not the gateway checks the responses for soap faults. This method
     * has no effect from C3 since C# is BasicProfile compliant and this will return a HTTP error
     * code 500.
     *
