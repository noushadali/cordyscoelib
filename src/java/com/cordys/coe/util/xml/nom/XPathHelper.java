...
public class XPathHelper
{
     ...
     */
    public static boolean getBooleanValue(int iNode, String sXPath, boolean bMandatory)
                                   throws NOMXPathParseException
    {
     ...
     * @throws  NOMXPathParseException  If the value cannot be found and bMandatory is true.
     */
    public static Date getDateValue(int iNode, String sXPath, boolean bMandatory)
                             throws NOMXPathParseException
    {
        Date dReturn = null;
     ...
     * @throws  NOMXPathParseException  If the value cannot be found and bMandatory is true.
     */
    public static int getIntegerValue(int iNode, String sXPath, boolean bMandatory)
                               throws NOMXPathParseException
    {
        int iReturn = -1;
     ...
     */
    public static long getLongValue(int iNode, String sXPath, boolean bMandatory)
                             throws NOMXPathParseException
    {
        long lReturn = -1;
     ...
     * @throws  NOMXPathParseException  If the value cannot be found and bMandatory is true.
     */
    public static String getStringValue(int iNode, String sXPath, boolean bMandatory)
                                 throws NOMXPathParseException
    {
        String sReturn = null;
        ...
        try
        {
            nsResult = XPath.getXPathInstance(sXPath).selectNodeSet(iNode, NamespaceConstants.getXPathMetaInfo());
