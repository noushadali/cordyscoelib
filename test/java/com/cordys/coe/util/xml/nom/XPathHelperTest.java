...
public class XPathHelperTest extends NomTestCase
{
    ...
    /**
     * Test method for {@link com.cordys.coe.util.xml.nom.XPathHelper#getStringValue(int, com.eibus.xml.xpath.XPath, com.eibus.xml.xpath.XPathMetaInfo, boolean)}.
     */
    public void testGetStringValueIntXPathXPathMetaInfoBoolean()
    {
        ...
        assertEquals("b1", XPathHelper.getStringValue(root, XPath.getXPathInstance("string(/a/b[1]/@attr)"), null, false));
    ...
    public void testGetStringValueIntXPathXPathMetaInfoBoolean_Namespace()
    {
        ...
        assertEquals("b3&valueb4", XPathHelper.getStringValue(root, XPath.getXPathInstance("//ns2:b/text()"), info, true));
        assertEquals("b3&value", XPathHelper.getStringValue(root, XPath.getXPathInstance("//ns2:b"), info, false));
        assertEquals("b3&value", XPathHelper.getStringValue(root, XPath.getXPathInstance("//ns2:b/text()"), info, false));
        assertEquals("b4", XPathHelper.getStringValue(root, XPath.getXPathInstance("/ns1:a/ns2:b[4]/text()"), info, true));
     
        // String value tests.
        assertEquals("b", XPathHelper.getStringValue(root, XPath.getXPathInstance("local-name(/ns1:a/*)"), info, true));
        assertEquals("b", XPathHelper.getStringValue(root, XPath.getXPathInstance("local-name(/ns1:a/*)"), info, false));
        assertEquals("b1", XPathHelper.getStringValue(root, XPath.getXPathInstance("string(/ns1:a/ns2:b[1]/@attr)"), info, false));
        
        //This test fails
        //assertEquals("", XPathHelper.getStringValue(root, XPath.getXPathInstance("string(/ns1:a/ns2:b[2]/@attr)"), info, false));
        
        assertEquals("b2", XPathHelper.getStringValue(root, XPath.getXPathInstance("string(/ns1:a/ns2:b[2]/@ns3:attr)"), info, false));
        
        // Boolean value tests.
        assertEquals("true", XPathHelper.getStringValue(root, XPath.getXPathInstance("/ns1:a/ns2:b/@attr = 'b1'"), info, true));
    }

    
    /**
     * Test method for {@link com.cordys.coe.util.xml.nom.XPathHelper#setNodeValue(int, com.eibus.xml.xpath.XPath, com.eibus.xml.xpath.XPathMetaInfo, boolean)}.
     */
